...
from nequip.utils.test import set_irreps_debug, add_spin
...
@pytest.fixture(scope="session")
def atomic_batch_spin(nequip_dataset):
    return Batch.from_data_list(
        add_spin([nequip_dataset[0], nequip_dataset[1]], spin_precent=0.5)
    )
