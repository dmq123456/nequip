...
class ConvNetLayer(GraphModuleMixin, torch.nn.Module):
    ...
    def __init__(
        ...
        # Here consider parity and time reversal together. (l.p + l.t)
        # Only when p==1 and l==1, "e" type activation is used.
        nonlinearity_scalars = {
            2: nonlinearity_scalars["e"],
            0: nonlinearity_scalars["o"],
            -2: nonlinearity_scalars["o"],
        }
        nonlinearity_gates = {
            2: nonlinearity_gates["e"],
            0: nonlinearity_gates["o"],
            -2: nonlinearity_gates["o"],
        }
        ...
        if nonlinearity_type == "gate":
            ...
            equivariant_nonlin = Gate(
                ...
                act_scalars=[
                    acts[nonlinearity_scalars[ir.p + ir.t]] for _, ir in irreps_scalars
                ],
                irreps_gates=irreps_gates,
                act_gates=[
                    acts[nonlinearity_gates[ir.p + ir.t]] for _, ir in irreps_gates
                ],
            ...
            equivariant_nonlin = NormActivation(
                ...
                scalar_nonlinearity=acts[nonlinearity_scalars[2]],
                normalize=True,
                epsilon=1e-8,
                bias=False,
            )
